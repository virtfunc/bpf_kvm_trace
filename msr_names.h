...
static const struct msr_def msr_names[] = { // used in binary search, must be sorted.
    ...
    { 0xC00000E7, "MSR_MPERF_READ_ONLY" },
    { 0xC00000E8, "MSR_APERF_READ_ONLY" },
    { 0xC00000E9, "MSR_IR_PERF_COUNT"},
    ...
    { 0xC0001019, "MSR_DR1_ADDR_MASK" },
    { 0xC000101A, "MSR_DR2_ADDR_MASK" },
    { 0xC000101B, "MSR_DR3_ADDR_MASK" },
    { 0xC0001027, "MSR_DR0_ADDR_MASK" },
